nasa app challenge - find your friend 데이터 분석 및 모델 개발 자료

각 데이터셋 별 상관관계 분석


## 목표 : disposition 예측
## 공통 전처리 0.05 이상 상관계수만 사용, 메타데이터 제거, 정답과 직접 연관있는 데이터 삭제 
...
## 2. cumulative https://exoplanetarchive.ipac.caltech.edu/cgi-bin/TblView/nph-tblView?app=ExoTbls&config=cumulative
약 9600개 특징 141개 

높은 상관관계 그리고 기타 답과 직접 연관있는 특징 제거 141 ->41
이 외에 라벨 정리
<img width="569" height="658" alt="image" src="https://github.com/user-attachments/assets/19cc9619-d534-4675-944b-337134cb45c1" />
[상위30개의 상관도]

결과 
AUC: 0.994 | F1: 0.980 | Precision: 0.978 | Recall: 0.982

## 3. TOI (TESS Objects of Interest)

7699개 특징 88 -> 16개

기존 라벨 ['FP', 'PC', 'KP', 'APC', 'FA', 'CP']
### APC = ambiguous planetary candidate, FA = false alarm, CP = confirmed planet, FP = false positive, KP = known planet, PC = planetary candidate
CP,KP -> 1 PC,APC -> test FA,FP -> 0

AUC: 0.844 | F1: 0.795 | Precision: 0.766 | Recall: 0.826
